...
<div class="manufacturer index large-9 medium-8 columns content">
    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                <th scope="col"><?= $this->Paginator->sort('MADE_BY') ?></th>
                <th scope="col"><?= $this->Paginator->sort('NAME') ?></th>
                <th scope="col"><?= $this->Paginator->sort('HELPLINE') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $manufacturer->MADE_BY]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $manufacturer->MADE_BY]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $manufacturer->MADE_BY], ['confirm' => __('Are you sure you want to delete # {0}?', $manufacturer->MADE_BY)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
