...
/* C:\xampp\htdocs\Project\vendor\cakephp\bake\src\Template\Bake\\Model\table.twig */
class __TwigTemplate_7ad39a7cbe13d56c1c7d5c3c15f000657fc0f993036d640ad37e77c36bed2d60 extends \Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_770edd655cdeb606afc443e4edb1f19b4248a91788cb82e88bf8b9495a7c5cfa->enter($__internal_770edd655cdeb606afc443e4edb1f19b4248a91788cb82e88bf8b9495a7c5cfa_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "C:\\xampp\\htdocs\\Project\\vendor\\cakephp\\bake\\src\\Template\\Bake\\\\Model\\table.twig"));

        // line 16
        $context["annotations"] = $this->getAttribute((isset($context["DocBlock"]) ? $context["DocBlock"] : null), "buildTableAnnotations", [0 => (isset($context["associations"]) ? $context["associations"] : null), 1 => (isset($context["associationInfo"]) ? $context["associationInfo"] : null), 2 => (isset($context["behaviors"]) ? $context["behaviors"] : null), 3 => (isset($context["entity"]) ? $context["entity"] : null), 4 => (isset($context["namespace"]) ? $context["namespace"] : null)], "method");
        // line 17
        echo "<?php
namespace ";
        // line 18
...
";
        // line 23
        echo $this->getAttribute((isset($context["DocBlock"]) ? $context["DocBlock"] : null), "classDescription", [0 => (isset($context["name"]) ? $context["name"] : null), 1 => "Model", 2 => (isset($context["annotations"]) ? $context["annotations"] : null)], "method");
        echo "
class ";
        // line 24
...
";
        ...
        if ((isset($context["primaryKey"]) ? $context["primaryKey"] : null)) {
            ...
            if ((twig_test_iterable((isset($context["primaryKey"]) ? $context["primaryKey"] : null)) && (twig_length_filter($this->env, (isset($context["primaryKey"]) ? $context["primaryKey"] : null)) > 1))) {
                ...
                echo $this->getAttribute((isset($context["Bake"]) ? $context["Bake"] : null), "stringifyList", [0 => (isset($context["primaryKey"]) ? $context["primaryKey"] : null), 1 => ["indent" => false]], "method");
                echo "]);";
                // line 47
                echo "
";
...
";
        ...
        foreach ($context['_seq'] as $context["behavior"] => $context["behaviorData"]) {
            ...
            echo "'";
            echo (($context["behaviorData"]) ? (((", [" . $this->getAttribute((isset($context["Bake"]) ? $context["Bake"] : null), "stringifyList", [0 => $context["behaviorData"], 1 => ["indent" => 3, "quotes" => false]], "method")) . "]")) : (""));
            echo ");
";
        }
        ...
        // line 62
        if ((($this->getAttribute((isset($context["associations"]) ? $context["associations"] : null), "belongsTo", []) || $this->getAttribute((isset($context["associations"]) ? $context["associations"] : null), "hasMany", [])) || $this->getAttribute((isset($context["associations"]) ? $context["associations"] : null), "belongsToMany", []))) {
            // line 63
            echo "
";
        }
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["assoc"]) {
                ...
                foreach ($context['_seq'] as $context["key"] => $context["val"]) {
                    if ( !($context["key"] === "alias")) {
                        // line 70
                        $context["assocData"] = twig_array_merge((isset($context["assocData"]) ? $context["assocData"] : null), [$context["key"] => $context["val"]]);
                    }
                }
                $_parent = $context['_parent'];
                ...
                echo "', [";
                echo $this->getAttribute((isset($context["Bake"]) ? $context["Bake"] : null), "stringifyList", [0 => (isset($context["assocData"]) ? $context["assocData"] : null), 1 => ["indent" => 3]], "method");
                echo "]);";
                // line 73
                echo "
";
...
";
            ...
            foreach ($context['_seq'] as $context["field"] => $context["rules"]) {
                // line 90
                $context["validationMethods"] = $this->getAttribute((isset($context["Bake"]) ? $context["Bake"] : null), "getValidationMethods", [0 => $context["field"], 1 => $context["rules"]], "method");
                // line 91
...
";
    ...
    {
        return "C:\\xampp\\htdocs\\Project\\vendor\\cakephp\\bake\\src\\Template\\Bake\\\\Model\\table.twig";
    }
...
", "C:\\xampp\\htdocs\\Project\\vendor\\cakephp\\bake\\src\\Template\\Bake\\\\Model\\table.twig", "C:\\xampp\\htdocs\\Project\\vendor\\cakephp\\bake\\src\\Template\\Bake\\\\Model\\table.twig");
    }
}
