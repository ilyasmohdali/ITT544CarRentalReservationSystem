...
/* C:\xampp\htdocs\Project\vendor\cakephp\bake\src\Template\Bake\\Template\view.twig */
class __TwigTemplate_e3fd08a9bae9c481ab64ca1cc5e395854855f4bd202e0bb0c1875b4d42140578 extends \Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $__internal_770edd655cdeb606afc443e4edb1f19b4248a91788cb82e88bf8b9495a7c5cfa->enter($__internal_770edd655cdeb606afc443e4edb1f19b4248a91788cb82e88bf8b9495a7c5cfa_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "template", "C:\\xampp\\htdocs\\Project\\vendor\\cakephp\\bake\\src\\Template\\Bake\\\\Template\\view.twig"));
...
";
        // line 22
        $context["associations"] = twig_array_merge(["BelongsTo" => [], "HasOne" => [], "HasMany" => [], "BelongsToMany" => []], (isset($context["associations"]) ? $context["associations"] : null));
        // line 23
        $context["fieldsData"] = $this->getAttribute((isset($context["Bake"]) ? $context["Bake"] : null), "getViewFieldsData", [0 => (isset($context["fields"]) ? $context["fields"] : null), 1 => (isset($context["schema"]) ? $context["schema"] : null), 2 => (isset($context["associations"]) ? $context["associations"] : null)], "method");
        // line 24
        $context["associationFields"] = $this->getAttribute((isset($context["fieldsData"]) ? $context["fieldsData"] : null), "associationFields", []);
        // line 25
        $context["groupedFields"] = $this->getAttribute((isset($context["fieldsData"]) ? $context["fieldsData"] : null), "groupedFields", []);
        // line 26
        $context["pK"] = ((("\$" . (isset($context["singularVar"]) ? $context["singularVar"] : null)) . "->") . $this->getAttribute((isset($context["primaryKey"]) ? $context["primaryKey"] : null), 0, [], "array"));
        // line 27
...
";
                    // line 40
                    $context["done"] = twig_array_merge((isset($context["done"]) ? $context["done"] : null), [0 => "controller"]);
                }
            }
...
";
        // line 49
        if ($this->getAttribute((isset($context["groupedFields"]) ? $context["groupedFields"] : null), "string", [], "array")) {
            // line 50
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["groupedFields"]) ? $context["groupedFields"] : null), "string", [], "array"));
            foreach ($context['_seq'] as $context["_key"] => $context["field"]) {
                // line 51
                if ($this->getAttribute((isset($context["associationFields"]) ? $context["associationFields"] : null), $context["field"], [], "array")) {
                    // line 52
                    $context["details"] = $this->getAttribute((isset($context["associationFields"]) ? $context["associationFields"] : null), $context["field"], [], "array");
                    // line 53
                    echo "        <tr>
            <th scope=\"row\"><?= __('";
                    // line 54
                    echo twig_escape_filter($this->env, Cake\Utility\Inflector::humanize($this->getAttribute((isset($context["details"]) ? $context["details"] : null), "property", [])), "html", null, true);
                    echo "') ?></th>
            <td><?= \$";
                    // line 55
                    echo twig_escape_filter($this->env, (isset($context["singularVar"]) ? $context["singularVar"] : null), "html", null, true);
                    echo "->has('";
                    echo twig_escape_filter($this->env, $this->getAttribute((isset($context["details"]) ? $context["details"] : null), "property", []), "html", null, true);
                    echo "') ? \$this->Html->link(\$";
                    echo twig_escape_filter($this->env, (isset($context["singularVar"]) ? $context["singularVar"] : null), "html", null, true);
                    echo "->";
                    echo twig_escape_filter($this->env, $this->getAttribute((isset($context["details"]) ? $context["details"] : null), "property", []), "html", null, true);
                    echo "->";
                    echo twig_escape_filter($this->env, $this->getAttribute((isset($context["details"]) ? $context["details"] : null), "displayField", []), "html", null, true);
                    echo ", ['controller' => '";
                    echo twig_escape_filter($this->env, $this->getAttribute((isset($context["details"]) ? $context["details"] : null), "controller", []), "html", null, true);
                    echo "', 'action' => 'view', \$";
                    echo twig_escape_filter($this->env, (isset($context["singularVar"]) ? $context["singularVar"] : null), "html", null, true);
                    echo "->";
                    echo twig_escape_filter($this->env, $this->getAttribute((isset($context["details"]) ? $context["details"] : null), "property", []), "html", null, true);
                    echo "->";
                    echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["details"]) ? $context["details"] : null), "primaryKey", []), 0, [], "array"), "html", null, true);
                    echo "]) : '' ?></td>
        </tr>
";
                } else {
...
";
        ...
        // line 65
        if ($this->getAttribute((isset($context["associations"]) ? $context["associations"] : null), "HasOne", [])) {
            // line 66
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["associations"]) ? $context["associations"] : null), "HasOne", []));
            foreach ($context['_seq'] as $context["alias"] => $context["details"]) {
                // line 67
                echo "        <tr>
            <th scope=\"row\"><?= __('";
...
";
        ...
        // line 73
        if ($this->getAttribute((isset($context["groupedFields"]) ? $context["groupedFields"] : null), "number", [])) {
            // line 74
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["groupedFields"]) ? $context["groupedFields"] : null), "number", []));
            foreach ($context['_seq'] as $context["_key"] => $context["field"]) {
                // line 75
                echo "        <tr>
            <th scope=\"row\"><?= __('";
...
";
        ...
        // line 81
        if ($this->getAttribute((isset($context["groupedFields"]) ? $context["groupedFields"] : null), "date", [])) {
            // line 82
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["groupedFields"]) ? $context["groupedFields"] : null), "date", []));
            foreach ($context['_seq'] as $context["_key"] => $context["field"]) {
                // line 83
                echo "        <tr>
            <th scope=\"row\"><?= __('";
...
";
        ...
        // line 89
        if ($this->getAttribute((isset($context["groupedFields"]) ? $context["groupedFields"] : null), "boolean", [])) {
            // line 90
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["groupedFields"]) ? $context["groupedFields"] : null), "boolean", []));
            foreach ($context['_seq'] as $context["_key"] => $context["field"]) {
                // line 91
                echo "        <tr>
            <th scope=\"row\"><?= __('";
...
";
        // line 98
        if ($this->getAttribute((isset($context["groupedFields"]) ? $context["groupedFields"] : null), "text", [])) {
            // line 99
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["groupedFields"]) ? $context["groupedFields"] : null), "text", []));
            foreach ($context['_seq'] as $context["_key"] => $context["field"]) {
                // line 100
                echo "    <div class=\"row\">
        <h4><?= __('";
...
";
        ...
        // line 106
        $context["relations"] = twig_array_merge($this->getAttribute((isset($context["associations"]) ? $context["associations"] : null), "BelongsToMany", []), $this->getAttribute((isset($context["associations"]) ? $context["associations"] : null), "HasMany", []));
        // line 107
        $context['_parent'] = $context;
...
";
            ...
            $context = array_intersect_key($context, $_parent) + $_parent;
            // line 125
            $context["otherPk"] = ((("\$" . (isset($context["otherSingularVar"]) ? $context["otherSingularVar"] : null)) . "->") . $this->getAttribute($this->getAttribute($context["details"], "primaryKey", []), 0, [], "array"));
            // line 126
...
";
    ...
    {
        return "C:\\xampp\\htdocs\\Project\\vendor\\cakephp\\bake\\src\\Template\\Bake\\\\Template\\view.twig";
    }
...
", "C:\\xampp\\htdocs\\Project\\vendor\\cakephp\\bake\\src\\Template\\Bake\\\\Template\\view.twig", "C:\\xampp\\htdocs\\Project\\vendor\\cakephp\\bake\\src\\Template\\Bake\\\\Template\\view.twig");
    }
}
